...
struct Z_CompiledInDeferFile_FID_Users_User_Downloads_workspace_unreal_UnrealPractice_ToonTanks_Source_ToonTanks_BasePawn_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ABasePawn, ABasePawn::StaticClass, TEXT("ABasePawn"), &Z_Registration_Info_UClass_ABasePawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABasePawn), 869290733U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Downloads_workspace_unreal_UnrealPractice_ToonTanks_Source_ToonTanks_BasePawn_h_2450968452(TEXT("/Script/ToonTanks"),
